...
tombolPesan.addEventListener("click", function (e) {
  ...
  if (nama.value == "" || destinasi.value == "" || status.value == "" || jumlah.value == "") {
    ...
    if (destinasi.value == "bandung") {
      ...
      document.getElementById("destinasioutput").innerText = destinasi.value;
    } else if (destinasi.value == "jogja") {
      document.getElementById("destinasioutput").innerText = destinasi.value;
    } else if (destinasi.value == "medan") {
      document.getElementById("destinasioutput").innerText = destinasi.value;
    } else if (destinasi.value == "bali") {
        document.getElementById("destinasioutput").innerText = destinasi.value;
    } else if (destinasi.value == "bogor") {
      document.getElementById("destinasioutput").innerText = destinasi.value;
    } else {
      alert("Pilihan destinasi hanya Bandung, Jakarta, Surabaya, Jogja, Medan, Bali, Bogor");
    }
